...
def seed_questions():
    ...
    music1 = Question(
        question_number=0,
        body="Which album won Album of The Year?",
        answer_1="Drake - Scorpion",
        answer_2="Brandi Carlile - By the way, I Forgive You",
        answer_3="Cardi B - Invasion of Privacy",
        correct_answer="Kacey Musgraves - Golden Hour",
        quiz=quizzes[8]
    )
